...
- project.Territory already exists in the base project schema and is used
  directly as the geographic / sales-territory dimension.

Power BI dimensions:
  1. project.Territory                 -> Territory / geographic dimension
  2. project.dimensioni_type_customer  -> Customer dimension
  3. project.dimensioni_prod_cat       -> Product hierarchy dimension
...
DROP TABLE IF EXISTS project.dimensioni_prod_cat;
GO

CREATE TABLE project.dimensioni_prod_cat (
    productid int NOT NULL,
    product nvarchar(50) NOT NULL,
    subcategory nvarchar(50) NULL,
    category nvarchar(50) NULL,

    CONSTRAINT PK_dimensioni_prod_cat
        PRIMARY KEY (productid)
);
GO

INSERT INTO project.dimensioni_prod_cat (
    productid,
    product,
    subcategory,
    category
...
/* ---------------------------------------------------------------------------
   ...
   The main sales fact layer can be related to the dimensions through:
     ...
     Sales / fact dataset
          |
          +-- ProductID   -> project.dimensioni_prod_cat.productid
          |
          +-- CustomerID  -> project.dimensioni_type_customer.customerId
          |
          +-- TerritoryID -> project.Territory.TerritoryID
          |
